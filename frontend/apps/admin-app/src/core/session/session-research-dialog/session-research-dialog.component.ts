...
import {TECHNOLOGY_TIER, TechnologyType, WorkflowParticipantInfo, WorkflowResearchRequest} from '@board-buddy/core'
...
export class SessionResearchDialogComponent {
  ...
  isDiscovered(tech: TechnologyType): boolean {
    return this.discovered().has(tech)
  }

  isResearchable(tech: TechnologyType): boolean {
    return this.researchable().has(tech)
  }
