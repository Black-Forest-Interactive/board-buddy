...
export const appRoutes: Route[] = [
  ...
  {path: 'impressum', loadChildren: () => import('../core/impressum/impressum.routes').then(m => m.routes)},
  {path: 'datenschutz', loadChildren: () => import('../core/datenschutz/datenschutz.routes').then(m => m.routes)},
